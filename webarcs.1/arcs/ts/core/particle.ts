...
/*
 * PSA: code in this file is subject to string manipulation by platforms. Not all syntax is supported.
 * e.g. Realms device extracts only the Particle class definition (module functions/variables are not supported).
 */
...
export class Particle {
  ...
  // subclasses may override
  public shouldRender(inputs, state) {
    return this.config.template;
  }
  // subclasses may override
  public render(inputs, state) {
    return inputs;
  }
