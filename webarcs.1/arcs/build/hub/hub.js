...
const log = logFactory(logFactory.flags["hub"], 'hub', 'green');
...
export class Hub extends EventEmitter {
    ...
    deviceChanged(device, docId) {
        ...
        Object.values(device.hub.connections).forEach((c) => c.database.add(store));
    }
    changed() {
    ...
    connectPeers(peers) {
        const connections = {};
        Object.keys(peers).forEach(peer => connections[peer] = new Connection(this, peer));
        return connections;
    }
