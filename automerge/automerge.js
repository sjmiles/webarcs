...
function clearConflicts(object, key) {
  return object[CONFLICTS][key] = [];
}
...
var _arr = ['canUndo', 'canRedo', 'getObjectId', 'getObjectById', 'getActorId', 'setActorId', 'getConflicts', 'clearConflicts', 'Text', 'Table', 'Counter'];
for (var _i = 0; _i < _arr.length; _i++) {
  var name = _arr[_i];
