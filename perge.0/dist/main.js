...
/******/ 	return __webpack_require__(__webpack_require__.s = "./depends.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "../node_modules/perge/dist/index.umd.js":
/*!***********************************************!*\
  !*** ../node_modules/perge/dist/index.umd.js ***!
  \***********************************************/
/*! no static exports found */
...
!function(e,t){ true?module.exports=t(__webpack_require__(/*! peerjs */ "../node_modules/peerjs/dist/peerjs.min.js"),__webpack_require__(/*! automerge */ "../node_modules/automerge/dist/automerge.js")):undefined}(this,function(e,t){return e=e&&e.hasOwnProperty("default")?e.default:e,class{constructor(n,o){void 0===o&&(o={}),this._connections={},this._actorId=n,this._peerInstance=o.peerInstance||new e(this._actorId),this._docSet=o.docSet||new t.DocSet,this._encode=o.encode||JSON.stringify,this._decode=o.decode||JSON.parse,this._peerInstance.on("connection",e=>{e.on("data",t=>{this._connections[e.peer].receiveMsg(this._decode(t))})})}get docSet(){return this._docSet}connect(e,n){if(!this._connections[e]){var o=n||this._peerInstance.connect(e),s=this._connections[e]=new t.Connection(this._docSet,e=>{o.send(this._encode(e))});o.on("disconnected",()=>{s.close(),delete this._connections[e]}),s.open()}}select(e){var n=this,o=this.docSet.getDoc(e)||t.init(this._actorId);return function(t){for(var s=arguments.length,c=new Array(s>1?s-1:0),i=1;i<s;i++)c[i-1]=arguments[i];var r=t(o,...c);return n.docSet.setDoc(e,r),r}}subscribe(e,t){if("function"==typeof e)return this.docSet.handlers=this.docSet.handlers.add(e),()=>this.docSet.handlers=this.docSet.handlers.delete(e);if("string"==typeof e){var n=(n,o)=>{n===e&&t(o)};return this.docSet.handlers=this.docSet.handlers.add(n),()=>this.docSet.handlers=this.docSet.handlers.delete(n)}}}});
...
/* harmony import */ var perge__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! perge */ "../node_modules/perge/dist/index.umd.js");
/* harmony import */ var perge__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(perge__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var automerge__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! automerge */ "../node_modules/automerge/dist/automerge.js");
/* harmony import */ var automerge__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(automerge__WEBPACK_IMPORTED_MODULE_1__);

window.Perge = perge__WEBPACK_IMPORTED_MODULE_0___default.a;

window.Automerge = automerge__WEBPACK_IMPORTED_MODULE_1___default.a;
